    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border-2 border-teal-200 bg-gradient-to-br from-teal-50 to-white shadow-lg hover:shadow-xl transition-all">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-teal-600 mb-1">کل کاربران</p>
                <p className="text-4xl font-bold text-teal-900">{stats.totalUsers}</p>
        ...
        <Card className="border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-white shadow-lg hover:shadow-xl transition-all">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-purple-600 mb-1">ارزیابی‌ها</p>
                <p className="text-4xl font-bold text-purple-900">{stats.totalEvaluations}</p>
        ...
        <Card className="border-2 border-amber-200 bg-gradient-to-br from-amber-50 to-white shadow-lg hover:shadow-xl transition-all">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-amber-600 mb-1">کارگروه‌ها</p>
                <p className="text-4xl font-bold text-amber-900">{stats.totalWorkgroups}</p>
        ...
        <Card className="border-2 border-rose-200 bg-gradient-to-br from-rose-50 to-white shadow-lg hover:shadow-xl transition-all">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-rose-600 mb-1">نرخ تکمیل</p>
                <p className="text-4xl font-bold text-rose-900">{stats.completionRate}%</p>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card className="border-2 border-teal-200 bg-white shadow-xl">
          <CardContent className="p-8">
            <div className="text-center">
              <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center shadow-lg mb-4">
                <TrendingUp className="w-10 h-10 text-white" />
              </div>
              <p className="text-sm font-semibold text-teal-600 mb-2">میانگین استراتژیست‌ها</p>
              <p className="text-5xl font-bold text-teal-900 mb-2">{stats.avgStrategistScore}</p>
              <p className="text-xs text-slate-600">از 10 امتیاز</p>
              <div className="mt-4 pt-4 border-t border-teal-100">
                <p className="text-2xl font-bold text-teal-700">{stats.totalStrategists}</p>
        ...
        <Card className="border-2 border-purple-200 bg-white shadow-xl">
          <CardContent className="p-8">
            <div className="text-center">
              <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-lg mb-4">
                <FileText className="w-10 h-10 text-white" />
              </div>
              <p className="text-sm font-semibold text-purple-600 mb-2">میانگین نویسندگان</p>
              <p className="text-5xl font-bold text-purple-900 mb-2">{stats.avgWriterScore}</p>
              <p className="text-xs text-slate-600">از 10 امتیاز</p>
              <div className="mt-4 pt-4 border-t border-purple-100">
                <p className="text-2xl font-bold text-purple-700">{stats.totalWriters}</p>
        ...
        <Card className="border-2 border-amber-200 bg-white shadow-xl">
          <CardContent className="p-8">
            <div className="text-center">
              <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center shadow-lg mb-4">
                <Award className="w-10 h-10 text-white" />
              </div>
              <p className="text-sm font-semibold text-amber-600 mb-2">میانگین بازخوردها</p>
              <p className="text-5xl font-bold text-amber-900 mb-2">{stats.avgFeedbackScore}</p>
              <p className="text-xs text-slate-600">از 10 امتیاز</p>
              <div className="mt-4 pt-4 border-t border-amber-100">
                <p className="text-2xl font-bold text-amber-700">{stats.totalFeedbacks}</p>
